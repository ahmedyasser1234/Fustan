  ...
  return (
    <div className={`min-h-screen bg-[#fafafa] pb-24 ${language === 'ar' ? 'text-right' : 'text-left'}`} dir={dir}>
      ...
      <section className="py-20 md:py-32 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center space-y-10 md:space-y-14">
            ...
            >
              ...
              <p className="text-xl md:text-3xl text-slate-500 font-bold max-w-2xl mx-auto">
                {language === 'ar' ? 'تواصلي مع المصمم' : 'Contact the Designer'}
              </p>
            </motion.div>
            ...
            >
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="group flex items-center justify-center gap-4 bg-[oklch(58.6%_0.253_17.585)] hover:bg-[oklch(58.6%_0.253_17.585)]/90 text-white p-6 rounded-[2rem] text-xl md:text-2xl font-black shadow-[0_20px_50px_rgba(233,30,99,0.3)] transition-all hover:scale-105 active:scale-95"
              >
                ...
                {language === 'ar' ? 'واتساب المصمم' : "Designer's WhatsApp"}
              </a>
            </motion.div>
          </div>
        </div>
        ...
        <div className="absolute top-0 left-0 w-64 h-64 bg-purple-50/40 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 -z-10" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-rose-50/30 rounded-full blur-3xl translate-x-1/2 translate-y-1/2 -z-10" />
      </section>
