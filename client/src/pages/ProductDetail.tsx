                ...
                {user?.role !== 'admin' && user?.role !== 'vendor' && (
                  <div className="flex flex-col md:flex-row gap-4" dir="rtl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 flex-1">
                      ...
                      }} className="h-14 md:h-16 rounded-full bg-blue-50 text-blue-600 border border-blue-100 hover:bg-blue-100 font-black flex-1 flex items-center justify-center gap-2">
