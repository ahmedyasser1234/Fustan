    ...
    return (
        <div className="min-h-screen bg-gray-50/30 pb-20 pt-32">
            <SEO
                ...
                description={language === 'ar' ? `اكتشفي أفضل الفساتين المتعلقة بـ ${query}` : `Discover the best dresses related to ${query}`}
            />

            <div className="container mx-auto px-4">
                {/* Search Header */}
                <div className="bg-white rounded-[2.5rem] p-8 md:p-12 mb-12 shadow-sm border border-gray-100 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-rose-50 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl opacity-50" />
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-slate-500 font-bold text-lg">
                                ...
                                <span className="mr-3 text-rose-600 bg-rose-50 px-3 py-1 rounded-full text-sm">
