...
import { MessageSquare, X, Send, Minimize2, Maximize2, AlertTriangle } from "lucide-react";
                        ...
                        return (
                            <div key={idx} className={`flex ${isMe ? "justify-end" : "justify-start"}`}>
                                <div className="flex flex-col">
                                    <div
                                        className={cn(
                                            "max-w-[85%] px-4 py-3 rounded-2xl text-sm font-medium shadow-sm transition-all relative group",
                                            isMe
                                        ...
                                        {isMe && (
                                            <div className="flex justify-end mt-1">
                                                {(msg as any).status === 'sending' && (
                                                    <div className="w-2 h-2 rounded-full bg-white/50 animate-pulse" title="Sending..." />
                                                )}
                                                {(msg as any).status === 'error' && (
                                                    <div className="flex items-center gap-1 text-[8px] text-red-200">
