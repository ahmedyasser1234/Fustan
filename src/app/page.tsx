...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen bg-[#fafafa] pb-24 ${language === 'ar' ? 'text-right' : 'text-left'}`} dir={dir}>
      ...
      {/* Design Your Dress Contact Section */}
      <section className="py-24 md:py-32 bg-gradient-to-b from-white via-rose-50/20 to-white relative overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center space-y-8 md:space-y-10">
            ...
            >
              <div className="flex justify-center mb-4">
                <div className="w-14 h-14 md:w-20 md:h-20 bg-rose-50 rounded-[2rem] flex items-center justify-center text-rose-500 shadow-inner border border-rose-100/50">
              ...
              <p className="text-lg md:text-xl text-slate-500 font-bold max-w-xl mx-auto leading-relaxed">
                {language === 'ar' ? 'تواصلي مع مصممين محترفين لتحويل خيالك إلى حقيقة' : 'Contact our expert designers to turn your imagination into reality'}
              </p>
            </motion.div>
              ...
              >
                <div className="bg-white/25 p-3 rounded-2xl group-hover:rotate-12 transition-transform">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.148-.67-1.613-.918-2.213-.242-.583-.487-.503-.67-.512-.172-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.067 2.877 1.215 3.076.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L0 24l6.335-1.662c1.72.937 3.659 1.432 5.623 1.432h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                  </svg>
                </div>
                <div className="flex flex-col items-start leading-none">
                  <span className="text-[10px] md:text-[12px] opacity-80 font-bold mb-1 uppercase tracking-widest">{language === 'ar' ? 'تواصل مباشر' : 'Quick Contact'}</span>
                  <span>{language === 'ar' ? 'واتساب المصمم' : "Designer's WhatsApp"}</span>
                </div>
              </a>
            </motion.div>
          </div>
        ...
        <div className="absolute top-0 left-0 w-80 h-80 bg-purple-100/30 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 -z-10" />
        <div className="absolute bottom-0 right-0 w-[30rem] h-[30rem] bg-rose-100/20 rounded-full blur-[100px] translate-x-1/2 translate-y-1/2 -z-10" />
            ...
            <div className="relative px-12">
              ...
              >
                <CarouselContent className="-ml-2 md:-ml-4">
                  {categories.map((category: any, i: number) => (
                    <CarouselItem key={category.id} className="pl-2 md:pl-4 basis-1/2 lg:basis-1/3">
                      <motion.div
                        initial={{ opacity: 0, scale: 0.95 }}
                        whileInView={{ opacity: 1, scale: 1 }}
                        viewport={{ once: true }}
                      ...
                      >
                        <Link href={`/products?category=${category.id}`}>
                          <div className="relative h-full w-full cursor-pointer overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors duration-500" />
                            <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                              <h3 className="text-white text-lg md:text-2xl lg:text-3xl font-medium drop-shadow-lg tracking-tight transition-transform duration-500 group-hover:scale-110">
                                {language === 'ar' ? category.nameAr : category.nameEn}
                              </h3>
                              <div className="mt-2 text-white/80 text-xs md:text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-500 translate-y-2 group-hover:translate-y-0">
                                {t('shopNow')}
                              </div>
                            </div>
                          </div>
                ...
                <CarouselPrevious className="-left-4 md:-left-12 bg-white text-slate-900 border-none shadow-xl hover:bg-slate-50" />
                <CarouselNext className="-right-4 md:-right-12 bg-white text-slate-900 border-none shadow-xl hover:bg-slate-50" />
              </Carousel>
            </div>
          )}
        </div>
