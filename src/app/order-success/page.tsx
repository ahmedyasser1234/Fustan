...
export default function OrderSuccessPage() {
    ...
    useEffect(() => {
        setMounted(true);
        document.title = language === 'ar' ? 'تم الطلب بنجاح | فستان' : 'Order Successful | Fustan';
    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center pt-20 pb-32 overflow-hidden relative">
            ...
            <div className="container mx-auto px-4 max-w-2xl text-center relative z-10">
                ...
                >
                    <Link href="/orders">
                        <Button className="w-full h-16 rounded-full bg-rose-600 hover:bg-rose-700 text-xl font-bold shadow-xl shadow-rose-100 gap-3 text-white">
                            <ShoppingBag size={24} />
                            {t('trackOrder')}
                        </Button>
                    </Link>
