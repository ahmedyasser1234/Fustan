...
export default function FAQPage() {
    ...
    useEffect(() => {
        setMounted(true);
        document.title = isAr ? 'الأسئلة الشائعة | فستان' : 'Frequently Asked Questions | Fustan';
    }, [isAr]);
        ...
        <div className="min-h-screen bg-white pt-32 pb-20" dir={isAr ? 'rtl' : 'ltr'}>
            <div className="container mx-auto px-4 max-w-3xl">
                <header className="text-center mb-10 md:mb-16">
                    ...
                    <h1 className="text-3xl md:text-3xl font-medium text-gray-900 mb-3 md:mb-4">
...
function FAQItem({ question, answer }: { question: string, answer: string }) {
    ...
    return (
        <div className={`border rounded-[2rem] transition-all duration-300 ${isOpen ? 'border-rose-200 bg-rose-50/20 shadow-lg shadow-rose-100' : 'border-gray-100 bg-white hover:border-gray-200'}`}>
            ...
            >
                <span className="text-base md:text-lg font-medium text-gray-900 text-start">{question}</span>
