...
export default function PrivacyPolicyPage() {
    ...
    useEffect(() => {
        setMounted(true);
        document.title = isAr ? 'سياسة الخصوصية | فستان' : 'Privacy Policy | Fustan';
    }, [isAr]);
            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                >
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-4 mb-8 border-b border-gray-100 pb-8 text-center md:text-right">
                        <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-rose-50 flex items-center justify-center text-rose-600 shrink-0">
                    ...
                    <div className="space-y-12 text-gray-600 leading-relaxed">
                        ...
                        <section className="bg-rose-50/50 p-6 rounded-3xl">
                            ...
                            <p className="text-sm font-bold text-gray-600 text-justify">
                                {isAr
