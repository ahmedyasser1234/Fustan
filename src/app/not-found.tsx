      ...
      <div className="container mx-auto px-4 max-w-2xl text-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/">
              <Button className="bg-rose-600 hover:bg-rose-700 text-white rounded-full px-10 h-16 text-xl font-medium shadow-xl shadow-rose-100 flex items-center gap-3 w-full sm:w-auto">
                <Home size={24} />
                {t('backToHome')}
              </Button>
            </Link>
            ...
            <Link href="/products">
              <Button variant="outline" className="rounded-full px-10 h-16 text-xl font-medium border-2 border-gray-100 hover:bg-gray-50 flex items-center gap-3 w-full sm:w-auto">
